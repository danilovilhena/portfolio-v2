      ...
      <div className="max-w-none">
        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-base leading-relaxed tracking-[-0.1px] text-neutral-500 dark:text-neutral-400">
              At Sereno - White Noises (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;), we are committed to protecting your privacy. This Privacy Policy
          ...
          <section>
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-4">
              ...
              <p className="text-sm tracking-[-0.1px] text-green-700 dark:text-green-300">
                <strong>Sereno - White Noises does not collect, store, or transmit any personal data or user information.</strong>
              </p>
            </div>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed tracking-[-0.1px] text-neutral-500 dark:text-neutral-400">
              Sereno - White Noises operates entirely offline on your device. All app functionality, including playing white noise sounds and managing premium
              features, happens locally without any data transmission to external servers.
            </p>
          </section>
        ...
        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          ...
          <p className="text-sm tracking-[-0.1px] text-blue-700 dark:text-blue-300">
            <strong>Your privacy is fully protected.</strong> Sereno - White Noises does not collect, store, or share any of your personal data. The app works
