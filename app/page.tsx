...
import { ExperienceDivider } from './components/experience-divider';
      ...
      <footer className="mx-auto w-full max-w-(--breakpoint-sm) px-4 py-4 mt-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <Button asChild variant="ghost" size="sm" className="text-xs font-[450] size-6 px-1.5 rounded-sm active:scale-95">
            <Link href="https://github.com/danilovilhena" target="_blank" rel="noopener noreferrer">
              <GithubIcon />
            </Link>
          </Button>
          <Button asChild variant="ghost" size="sm" className="text-xs font-[450] size-6 px-1.5 rounded-sm active:scale-95">
            <Link href="https://linkedin.com/in/danilo-vilhena" target="_blank" rel="noopener noreferrer">
              <LinkedinIcon />
            </Link>
          </Button>
          <ThemeToggle />
